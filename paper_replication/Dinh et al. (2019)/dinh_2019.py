#python "paper_replication/Dinh et al. (2019)/dinh_2019.py"
...
df = compile_data(dinh_2019_variables)


df = pd.read_parquet(RAW_DATA_PATH + "dinh_raw_data.parquet")

def preprocessing_nhanes(data):
    df = data.copy()

    # These are c variables that have coded categorical answers "Don't know" and "Refused" as numerical
